...
function App() {
  const stripePromise = loadStripe(
    "pk_test_51OsJucSASJsvxx3ajtBeIdVjowQ3zU9wZntfqgJDZWrdeBXeotCa8JrTNY0bAGop6VLjl5HRkz8sR4tFZZVkA02o00hHcsiFZZ"
    )
  ...
  const router = createBrowserRouter(
    ...
    createRoutesFromElements(
      ...
      <Route path='/' element={<Main />} id='main' exact>
        ...
        <Route id="forgotpassword" path="user/forgotpassword" element={<ForgetPassword/>}/>
